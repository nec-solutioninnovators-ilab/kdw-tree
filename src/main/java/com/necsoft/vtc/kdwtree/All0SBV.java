...
/**
 * Implementation of Bit-vector which contains zero-bits only.
 * <pre>
 * Constructing sample.
 * SuccinctBitVector sbv = new All0SBV(length); // call constructor specifying length (number of bits)
 * // Calling append(), build() are unnecessary.
 * </pre>
 */
class All0SBV implements SuccinctBitVector{
